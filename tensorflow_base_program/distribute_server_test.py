...
"""
运行命令：
python distribute_server_test.py --job_name=ps --task_index=0
python distribute_server_test.py --job_name=ps --task_index=1
python distribute_server_test.py --job_name=work --task_index=0
python distribute_server_test.py --job_name=work --task_index=1
python distribute_server_test.py --job_name=work --task_index=2
"""
